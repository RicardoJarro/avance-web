                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                ...
                                <li><a href="#"><i class="fa fa-phone"></i>Numero de Telefono</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>dispers@email.com</a></li>
                                <li><a href="#"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Ayuda</a></li>
                            </ul>
                        </div>
                    </div>

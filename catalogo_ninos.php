                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9 d-inline-block contenedor-catalogo m-0 p-0">
                    <div class="w-100">
                        ...
                        <div class="product-catalog">
                            <a href="#">
                                <img src="images/ninos/buso-reno_1_blanco.jpg">
                                <div class="product-catalog-info">
                                    <p id="nombre">BUSO RENO</p>
                                    <p id="precio">19.99 $</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="product-catalog">
                            <a href="#">
                                <img src="images/ninos/body-panda_1_azulcielo.jpg">
                                <div class="product-catalog-info">
                                    <p id="nombre">BODY PANDA</p>
                                    <p id="precio">19.99 $</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="product-catalog">
                            <a href="#">
                                <img src="images/ninos/camiseta-planetas_1_negro.jpg">
                                <div class="product-catalog-info">
                                    <p id="nombre">CAMISETA PLANETAS</p>
                                    <p id="precio">19.99 $</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="product-catalog">
                            <a href="#">
                                <img src="images/ninos/camiseta-aguacate_1_negro.jpg">
                                <div class="product-catalog-info">
                                    <p id="nombre">CAMISETA AGUCATE STYLE</p>
                                    <p id="precio">19.99 $</p>
                                </div>
                            </a>
                        </div>
